...
#'
#' @return Returns bus location data in GTFS-RT format. More detail on this format can be found \link(https://data.bus-data.dft.gov.uk/guidance/requirements/?section=dataformats)
